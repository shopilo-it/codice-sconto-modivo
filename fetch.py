#!/usr/bin/env python3
"""
Recupero codici sconto Modivo da shopilo.it
Sursa: https://shopilo.it/negozi/modivo.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/modivo.it"
STORE_NAME = "Modivo"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Modivo da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-modivo)"
    }
    try:
